...
def promote_single_step(
    ...
    if glci.model.BuildTarget.PUBLISH not in build_target_set:
        print(
            f'publishing action {glci.model.BuildTarget.PUBLISH=} not specified'
            ' - exiting now'
        )
        sys.exit(0)
...
def promote_step(
    ...
    if glci.model.BuildTarget.PUBLISH in build_target_set:
        print(
            f'publishing action {glci.model.BuildTarget.PUBLISH=} specified - exiting now'
        )
        sys.exit(0)
